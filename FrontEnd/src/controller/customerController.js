...
function loadAllCustomers() {
    ...
    $.ajax({
        url: "http://localhost:8082/RoadRescue/customer?option=GETALL",
        method: "GET",
        success: function (res) {
...
$("#btnSearch").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8082/RoadRescue/customer?option=SEARCH&searchId=" + searchID,
        method: "GET",
        success: function (res) {
            if (res.status == 200) {
...
function deleteCustomer(id) {
    ...
    $.ajax({
        url: "http://localhost:8082/RoadRescue/customer?cstId=" + id,
        method: "delete",
        success: function (res) {
            if (res.status == 200) {
                alert(res.message);
...
/*function checkAlreadyExits(cusID) {
    ...
    var index = 0;
    $.ajax({
       // url: "http://localhost:8082/RoadRescue/customer?option=SEARCH&searchId=" + cusID,
        method: "GET",
        success: function (res) {
